...
import net.minecraft.item.ItemArmor;  // Import the ItemArmor class
	    ...
	    if(this.mc.playerController.shouldDrawHUD()) {
	        ...
	        for(var11 = 0; var11 < 10; ++var11) {
	            ...
	            if(var10 > 0) {
	                ...
	                // Get the armor item in the slot
	                ItemStack armorItem = var5.armorItemInSlot(var11 / 2);
	                if (armorItem != null && armorItem.getItem() instanceof ItemArmor) {
	                    ItemArmor armor = (ItemArmor) armorItem.getItem();
	                    int color = armor.getColor(armorItem);
	                ...
	                // Reset the color to white after drawing each armor piece
	                GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
	            }
